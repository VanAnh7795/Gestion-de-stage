...
<form method="post" action="../../../controller/user/tuteur/edit_etuteur.php" role="form">
	<div class="modal-body">
		<div class="form-group">
			<label for="etu">Soutenance ID</label>
			<input type="text" class="form-control" id="etu" name="etu" value="<?php echo $info['stid'];?>" readonly="true"/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="stage">Titre de stage</label>
			<input type="text" class="form-control" id="stage" name="stage" value="<?php echo $info['titre'];?>" readonly="true"/>
		</div>
		<div class="form-group">
			<label for="note">Date</label>
			<input type="text" class="form-control" id="note" name="note" value="<?php echo $info['date'];?>" readonly="true"/>
		</div>
		<div class="form-group">
			<label for="commentaire">Salle</label>
			<input type="text" class="form-control" id="commentaire" name="commentaire" value="<?php echo $info['salle'];?>" readonly="true" />
		</div> 
		<div class="form-group">
