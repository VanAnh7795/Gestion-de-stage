...
<section>
  <button type="button" class="btn btn-info pull-right" data-toggle="modal" data-target="#addStnModal"><i class="glyphicon glyphicon-plus"></i> Ajouter soutenance</button>
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">La liste des soutances</h1>
      </div>
    </div>
    <div class="row">
            ...
            <div class="modal fade" id="addStnModal" tabindex="-1" role="dialog" aria-labelledby="Ajout Soutenance" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="addStn">
                   <form action="../../../controller/user/responsable/add_soutenance.php" method="post">   
      ...
      buttons: {
       ...
       danger: {
         ...
         callback: function() {
          $.ajax({
           type: 'POST',
           url: '../../../controller/user/responsable/delete_stn.php',
           data: 'delete='+stid
         })
